...
<main>
	<section class="page-hero bg-surface reveal" aria-label="<?php echo privacyAttr('legal.privacy.hero.title'); ?>">
		<div class="container text-center">
			...
			<h1 class="display-5 fw-medium text-balance mb-3" data-i18n="legal.privacy.hero.title"><?php echo privacyAttr('legal.privacy.hero.title'); ?></h1>
			...
			<div class="row g-4">
				<div class="col-lg-4">
					<div class="card-min p-4 h-100">
						<h2 class="h4 fw-medium mb-3" data-i18n="legal.privacy.responsible.title"><?php echo privacyAttr('legal.privacy.responsible.title'); ?></h2>
				...
				<div class="col-lg-8">
					<div class="card-min p-4 p-lg-5 h-100">
						<h2 class="h3 fw-medium mb-3" data-i18n="legal.privacy.intro.title"><?php echo privacyAttr('legal.privacy.intro.title'); ?></h2>
	...
	<section class="py-6 bg-surface reveal">
		<div class="container">
			<div class="row g-4">
				<div class="col-lg-6">
					<div class="card-min p-4 h-100">
						<h2 class="h4 fw-medium mb-3" data-i18n="legal.privacy.data.title"><?php echo privacyAttr('legal.privacy.data.title'); ?></h2>
				...
				<div class="col-lg-6">
					<div class="card-min p-4 h-100">
						<h2 class="h4 fw-medium mb-3" data-i18n="legal.privacy.uses.title"><?php echo privacyAttr('legal.privacy.uses.title'); ?></h2>
						<?php privacyList([
	...
	<section class="py-6 bg-card reveal">
		<div class="container">
			<div class="row g-4">
				<div class="col-lg-6">
					<div class="card-min p-4 h-100">
						<h2 class="h4 fw-medium mb-3" data-i18n="legal.privacy.sharing.title"><?php echo privacyAttr('legal.privacy.sharing.title'); ?></h2>
				...
				<div class="col-lg-6">
					<div class="card-min p-4 h-100">
						<h2 class="h4 fw-medium mb-3" data-i18n="legal.privacy.transfers.title"><?php echo privacyAttr('legal.privacy.transfers.title'); ?></h2>
		...
		<div class="container">
			<div class="row g-4">
				<div class="col-md-6 col-lg-4">
					<div class="card-min p-4 h-100">
						<h2 class="h4 fw-medium mb-3" data-i18n="legal.privacy.retention.title"><?php echo privacyAttr('legal.privacy.retention.title'); ?></h2>
				...
				<div class="col-md-6 col-lg-4">
					<div class="card-min p-4 h-100">
						<h2 class="h4 fw-medium mb-3" data-i18n="legal.privacy.cookies.title"><?php echo privacyAttr('legal.privacy.cookies.title'); ?></h2>
				...
				<div class="col-md-6 col-lg-4">
					<div class="card-min p-4 h-100">
						<h2 class="h4 fw-medium mb-3" data-i18n="legal.privacy.security.title"><?php echo privacyAttr('legal.privacy.security.title'); ?></h2>
	...
	<section class="py-6 bg-surface reveal">
		<div class="container">
			<div class="row g-4">
				<div class="col-lg-6">
					<div class="card-min p-4 h-100">
						<h2 class="h4 fw-medium mb-3" data-i18n="legal.privacy.minors.title"><?php echo privacyAttr('legal.privacy.minors.title'); ?></h2>
				...
				<div class="col-lg-6">
					<div class="card-min p-4 h-100">
						<h2 class="h4 fw-medium mb-3" data-i18n="legal.privacy.changes.title"><?php echo privacyAttr('legal.privacy.changes.title'); ?></h2>
